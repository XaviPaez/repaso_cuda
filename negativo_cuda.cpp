...
static const std::string filename = "C:/Users/user/CLionProjects/untitled/image02.jpg";
...
void convert_image_negativo() {
    ...
    kernel_negativo_ex(device_src_image_pixels, device_blur_image_pixels, image_width, image_height);
