...
static const std::string filename = "C:/Users/user/CLionProjects/untitled/image01.jpg";
static const std::string filename2 = "C:/Users/user/CLionProjects/untitled/pikachu.jpg";
...
const sf::Uint8 * host_src_image_pixels2 = nullptr;

sf::Uint8 * host_blur_image_pixels = nullptr;

sf::Uint8 * device_src_image_pixels = nullptr;
sf::Uint8 * device_src_image_pixels2 = nullptr;
...
void convert_image_sum() {
    ...
    CHECK(cudaMemcpy(device_src_image_pixels2, host_src_image_pixels2, buffer_size, cudaMemcpyHostToDevice));


    kernel_sum_ex(device_src_image_pixels,device_src_image_pixels2 , device_blur_image_pixels, image_width, image_height);
...
int main() {
    ...
    host_src_image_pixels2 = im2.getPixelsPtr();
    ...
    CHECK(cudaMalloc(&device_src_image_pixels2, buffer_size));
